...
const Spotlight = () => {
  ...
  const spotlightItems = [
    { name: "Relaxing Bath", img: "/spotlight/spotlight-img-1.jpg" },
    { name: "Sauna", img: "/spotlight/spotlight-img-2.jpg" },
    { name: "Manicure", img: "/spotlight/spotlight-img-3.jpg" },
    { name: "Jacuzzi", img: "/spotlight/spotlight-img-4.jpg" },
    { name: "Massage", img: "/spotlight/spotlight-img-5.jpg" },
  ];
